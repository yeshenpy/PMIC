...
class MultiAgentEnv(gym.Env):
    ...
    def _set_action(self, action, agent, action_space, time=None):
        ...
        if isinstance(action_space, MultiDiscrete):
         ...
         #   print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
            #print("MultiDiscrete",action_space.high,action_space.low  )
            act = []
         ...
         #   print("size ",size)
            ...
            #print("not  MultiDiscrete")
            action = [action]
            
        
        #print("1",action)
        #print("2",self.discrete_action_space)
        if agent.movable:
            # physical action
            if self.discrete_action_input:
               ...
               # print("!!!!!!!!!! ",   self.force_discrete_action)
        ...
        if not agent.silent:
          ...
          #  print("self.discrete_action_input  ",self.discrete_action_input)
            if self.discrete_action_input:
                agent.action.c = np.zeros(self.world.dim_c)
